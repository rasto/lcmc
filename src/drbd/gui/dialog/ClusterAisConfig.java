 ...
 *
 */
public class ClusterAisConfig extends DialogCluster {
    /** Serial version UID. */
    ...
    private final MyButton makeConfigButton =
      new MyButton(Tools.getString("Dialog.ClusterAisConfig.CreateAisConfig"));
     ...
     */
    public ClusterAisConfig(final WizardDialog previousDialog,
    ...
    protected final String getClusterDialogTitle() {
        return Tools.getString("Dialog.ClusterAisConfig.Title");
    }
    ...
    protected final String getDescription() {
        return Tools.getString("Dialog.ClusterAisConfig.Description");
    }
    ...
    private MyButton getRemoveButton(final AisCastAddress c) {
        final MyButton removeButton = new MyButton(
                    Tools.getString("Dialog.ClusterAisConfig.RemoveIntButton"));
    ...
    protected final JComponent getInputPane() {
        ...
        addrCB = new GuiComboBox(
                Tools.getDefault("Dialog.ClusterAisConfig.DefaultMCastAddress"),
                null,
                null,
                regexp,
                ADDR_COMBOBOX_WIDTH,
        ...
        portCB = new GuiComboBox(
                Tools.getDefault("Dialog.ClusterAisConfig.DefaultMCastPort"),
                null,
                null,
                portRegexp,
                PORT_COMBOBOX_WIDTH,
        ...
        addButton = new MyButton(
                       Tools.getString("Dialog.ClusterAisConfig.AddIntButton"));
        ...
        mgmtdCB = new JCheckBox(
                    Tools.getString("Dialog.ClusterAisConfig.UseMgmtdCheckBox"),
                    null,
                    false);
        mgmtdCB.setToolTipText(
          Tools.getString("Dialog.ClusterAisConfig.UseMgmtdCheckBox.ToolTip"));
