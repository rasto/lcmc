 ...
 *
 */
public class DrbdSplitBrain extends DrbdConfig {
    /** Serial version UID. */
    ...
    private final MyButton resolveButton = new MyButton(
                    Tools.getString("Dialog.DrbdSplitBrain.ResolveButton"));
    /** Width of the combo box. */
    private static final int COMBOBOX_WIDTH = 160;

    /**
     * Prepares a new <code>DrbdSplitBrain</code> object.
     */
    public DrbdSplitBrain(final WizardDialog previousDialog,
    ...
    protected final JComponent getInputPane() {
        ...
        final JLabel hostLabel = new JLabel(
                        Tools.getString("Dialog.DrbdSplitBrain.ChooseHost"));
