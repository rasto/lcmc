...
public class SSH {
    ...
    private boolean disconnectForGood = true;
        ...
        */
        ...
        public final void run() {
            ...
            if (connection == null) {
                ...
                try {
                    ...
                    connection = null;
                    Tools.appError("Could not open session", e);
                }
                exec();
            }
        }
        ...
        private void exec() {
            ...
            for (int i = 0; i < commands.length; i++) {
                ...
                final Object[] ret = execOneCommand(commands[i], outputVisible);
                ans.append(ret[0]);
                //Tools.commandUnlock();
