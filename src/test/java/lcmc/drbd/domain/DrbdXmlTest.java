...
class DrbdXmlTest {
    ...
    void shouldParseDrbdEvent() {
        ...
        boolean ret = drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "40 ST 0,r0[0] { cs:WFReportParams ro:Secondary/Unknown ds:Attaching/DUnknown r--- }");
    ...
    @Test
    void shouldParseCreateDrbdEvent2() {
        drbdXml.addDeviceAddResource("/dev/drbd0", "r0");
        drbdXml.addHostDiskMap("r0", "0", ImmutableMap.of("host1", "/dev/sda1", "host2", "/dev/sda1"));
        val blockDevice = new BlockDevice(host1, "/dev/sda1");
        when(blockDevInfo.getBlockDevice()).thenReturn(blockDevice);
        ...
        boolean ret = drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "create resource name:r0 role:Secondary suspended:no may_promote:no promotion_score:0");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "create device name:r0 volume:0 minor:0 backing_dev:none disk:Diskless client:no quorum:yes");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "create connection name:r0 peer-node-id:1 conn-name:centos8-b connection:StandAlone role:Unknown");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "create peer-device name:r0 peer-node-id:1 conn-name:centos8-b volume:0 replication:Off peer-disk:DUnknown peer-client:no resync-suspended:no");
        ...
        assertThat(blockDevice.isConnectedOrWF()).isFalse();
        assertThat(blockDevice.getNodeState()).isEqualTo("Secondary");
        assertThat(blockDevice.getConnectionState()).isEqualTo("StandAlone");
        assertThat(blockDevice.getDiskState()).isEqualTo("Diskless");
    }
    ...
    void shouldParseSyncingDrbdEvent() {
        ...
        boolean ret = drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "exists peer-device name:r0 peer-node-id:1 conn-name:centos8-b volume:0 replication:SyncSource peer-disk:Inconsistent peer-client:no resync-suspended:no done:1.84");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "change peer-device name:r0 peer-node-id:0 conn-name:centos8-a volume:0 done:1.14");
    ...
    void shouldParseDrbdChangeEvent2() {
        ...
        assertThat(blockDevice.isAttached()).isTrue();
        assertThat(blockDevice.isAvailable()).isTrue();
        assertThat(blockDevice.isConnected()).isTrue();
        assertThat(blockDevice.isWFConnection()).isFalse();
        assertThat(blockDevice.isConnectedOrWF()).isTrue();
        assertThat(blockDevice.getNodeState()).isEqualTo("Secondary");
    ...
    void shouldParseSplitBrainDrbdEvent() {
        ...
        val ret = drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "call helper name:r0 peer-node-id:1 conn-name:centos8-b volume:0 minor:0 helper:split-brain");
    ...
    private boolean drbdEventsConnect() {
        ...
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "change device name:r0 volume:0 minor:0 backing_dev:none disk:Attaching client:no quorum:yes");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "change device name:r0 volume:0 minor:0 backing_dev:/dev/sdb disk:Inconsistent client:no quorum:yes");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "change connection name:r0 peer-node-id:1 conn-name:centos8-b connection:Unconnected");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "change connection name:r0 peer-node-id:1 conn-name:centos8-b connection:Connecting");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "change path name:r0 peer-node-id:1 conn-name:centos8-b local:ipv4:192.168.133.80:7788 peer:ipv4:192.168.133.83:7788 established:yes");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "change peer-device name:r0 peer-node-id:1 conn-name:centos8-b volume:0");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "change connection name:r0 peer-node-id:1 conn-name:centos8-b connection:Connected role:Secondary");
        drbdXml.parseDrbdEvent("host1", List.of("host2"), drbdGraph, "change peer-device name:r0 peer-node-id:1 conn-name:centos8-b volume:0 replication:Established peer-disk:Inconsistent peer-client:no");
        return ret;
    }
