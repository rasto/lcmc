...
final class HbColocationInfo extends EditableInfo implements HbConstraintInterface {
    ...
    public HbColocationInfo(Application application, SwingUtils swingUtils, Access access, MainData mainData,
            WidgetFactory widgetFactory) {
        super(application, swingUtils, access, mainData, widgetFactory);
    }

    void init(final HbConnectionInfo connectionInfo, final ServiceInfo serviceInfoRsc, final ServiceInfo serviceInfoWithRsc,
