...
final class SerialInfo extends ParallelSerialInfo {
    ...
    public SerialInfo(Application application, SwingUtils swingUtils, MenuFactory menuFactory, WidgetFactory widgetFactory, MainData mainData, ClusterTreeMenu clusterTreeMenu) {
